...
function DrumPad (props) {
  ...
  const playAudio = (e) => { 
    const audio = document.getElementById(props.keyString);
    audio.play();
    props.updateDisplay(props.drumpadId);
   }
...
const InnerContainer = () => {
    ...
    let innerContainer = this.props.currentPadBank.map((item, index, array) => {
      return(
      <DrumPad
      key={index} 
