...
class DrumPad extends React.Component {
  ...
  playSound(e) { 
   const audio = document.getElementById(this.props.keyString);
   audio.currentTime = 0;
   audio.play();
    ...
    return(
      <div 
        ...
        <audio //ref={this.myRef}
         className='clip' id={this.props.keyString} src={this.props.clipSource} ></audio>
...
//var arrbank = this.props.currentPadBank
//arrbank = keyIndex(arrbank, 1); 
//console.log(arrbank)

   let padBank = this.props.currentPadBank.map((item, index, array) => {
    //let padBank = arrbank.map((item, _keyCodeId, array) => {
